...
description: In this lab, you'll explore one of the first and largest transcriptomic studies of of SARS-CoV-2. You start by exploring the study metadata to identify a question you're interested in, formulate a hypothesis, and carry out an analysis of the data to test this hypothesis.
