...
**You should start working on this dataset by Nov 4th.**.  Use the week in advance of this lab to work through the dataset either alone, or together with your classmates (don't forget that you can use the call/videoconference function directly within the course Slack page).  

The Nov 10th lab will follow the same format as usual.  You will work with your usual lab group to discuss the various approaches/questions that each person pursued, then bring your different perspectives together to produce a final figure or set of figures that illustrates what you found.  
