...
#using 'myCollapsedData' object created from dplyr mutate command
load("myCollapsedData")
...
shinyServer(function(input, output) {
  ...
  vis <- reactive({
   ...
   #passing 'myCollapsedData' to ggvis to make a graph 
    myCollapsedData %>% 
  ...
  output$view <- DT::renderDataTable(myCollapsedData, server = TRUE)
})
