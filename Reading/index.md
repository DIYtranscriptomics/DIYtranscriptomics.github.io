...
* **[The Art of R programming by Norman Matloff](http://TranscriptomicsWorkshop.github.io/Reading/files/The Art of R Programming.pdf)**
...
* the [April 2016 Nature Biotech paper](http://transcriptomicsworkshop.github.io/Reading/files/Kallisto.pdf) from Lior Pachter's lab describing Kallisto
...
* Did you notice that Kallisto is using 'Expectation Maximization (EM)' during the alignment?  You can read more about what this is [here](http://transcriptomicsworkshop.github.io/Reading/files/EM.pdf)
...
* [This 2014 Nature Biotech paper](http://transcriptomicsworkshop.github.io/Reading/files/Sailfish.pdf) described Sailfish, which implimented the first lightweight method for quantifying transcript expression.
...
* Don't understand what a de Bruijn graph is? Find out more in the [this primer from Nature Biotechnology](http://transcriptomicsworkshop.github.io/Reading/files/deBruijn.pdf)

* [Lior Pachter's talk at Cold Spring Harbor](http://theleadingstrand.cshl.edu/Course/Keynote/2013/INFO/135)

* [Greg Grant's recent paper comparing different aligners](http://transcriptomicsworkshop.github.io/Reading/files/gregGrant_aligners_natMeth.pdf).  This should be a helpful guide in choosing alignment software outside of what we used in class.
...
* _Measurement of mRNA abundance using RNA-seq data: RPKM measure is inconsistent among samples_ [Theory in Biosciences, Dec 2012](http://transcriptomicsworkshop.github.io/Reading/files/wagnerTPM.pdf)

* _Revisiting global Gene Expression Analysis_ [Cell, Oct 2012](http://transcriptomicsworkshop.github.io/Reading/files/Revisiting global gene express.pdf). A great example of the perils of normalizing to total read depth.
...
* _voom: precision weights unlock linear model analysis tools for RNA-seq read counts_ [Genome Biology, Feb, 2014](http://transcriptomicsworkshop.github.io/Reading/files/voom.pdf). Describes one of the approaches for normalizing RNAseq data that we'll use in class.
...
* _Count-based differential expression analysis of RNA sequencing data using R and Bioconductor_ [Nature Protocols, Aug 22, 2013](http://transcriptomicsworkshop.github.io/Reading/files/nprot.2013.099.pdf).  This is great overview of the edgeR and DESeq packages, their use, and explains how each one approaches differential gene expression.
...
* you know how I feel about Venn diagrams, so if you're interested in exploring interactions between many groups of genes, have a look at [this Nature Methods paper](http://transcriptomicsworkshop.github.io/Reading/files/upSet_plot.pdf), the accompanying R package, [UpSetR](https://cran.r-project.org/web/packages/UpSetR/README.html), as well as the [UpSet website](http://caleydo.org/tools/upset/).  Note, there's a shiny app for this as well!
...
* [The what, where, how and why of gene ontology -- a primer for bioinformaticians.](http://transcriptomicsworkshop.github.io/Reading/files/GO.pdf)  Briefings in Bioinformatics, Feb 2011

* The [original 2003 Nat. Methods paper describing Gene Set Enrichment Analysis (GSEA)](http://transcriptomicsworkshop.github.io/Reading/files/Mootha2003_GSEA.pdf), and the [2005 PNAS paper](http://mootha.med.harvard.edu/PubPDFs/Subramanian2005.pdf) that formally detailed its usage.

* Not a fan of using the Broad Inst. GSEA program?  You can carry out self-contained and competitive GSEA in R using [ROAST](http://transcriptomicsworkshop.github.io/Reading/files/ROAST.pdf) and [CAMERA](http://transcriptomicsworkshop.github.io/Reading/files/CAMERA.pdf), respectively.

* The paper describing [Gene Set VARIATION Analysis (GSVA)](http://transcriptomicsworkshop.github.io/Reading/files/GSVA.pdf), which I find useful for looking GSEA-type results across a heterogeneous dataset (like a large cohort of patients).

* The Molecular Signatures Database [(MSigDB)](http://software.broadinstitute.org/gsea/msigdb)

* [2016 Immunity Paper](http://transcriptomicsworkshop.github.io/Reading/files/ImmuneSigDB.pdf) describing how the 'Immunological Signatures' collection (C7) in MSigDB was created.
...
* For an example of how markdown/knitr can be used with publications, checkout [this Supplementary code](http://transcriptomicsworkshop.github.io/Reading/files/supplementaryCode.pdf) in a recent [Nature Immunology paper](http://transcriptomicsworkshop.github.io/Reading/files/singleCellTranscriptome.pdf) or our recent [PLOS Pathogens paper](http://journals.plos.org/plospathogens/article?id=10.1371/journal.ppat.1005347) 
