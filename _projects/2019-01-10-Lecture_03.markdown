...
description: In this class we'll finally get down to the business of using Kallisto for memory-efficient mapping of your raw reads to a reference transcriptome.  You'll carry out this mapping in class, right on your laptop, while we discuss what's happening under the hood.  In the process, you'll learn the basics of using command line software and how to use shell scripts for automation and reproducibility.
