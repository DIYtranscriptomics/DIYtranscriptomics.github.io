...
description: In this class you'll be introduced to Kallisto, software for memory-efficient mapping of  raw reads to a reference transcriptome. You'll be introduced to using command line software and will learn about automation and reproducibility through shell scripts. 
