...
subtitle: 'Lecture 7 • watch by February 26, 2025'
...
ARCHS4 database in HDF5 format for **[mouse](https://s3.dev.maayanlab.cloud/archs4/files/mouse_gene_v2.latest.h5)** and **[human](https://s3.dev.maayanlab.cloud/archs4/files/human_gene_v2.latest.h5)**.  These HDF5 files contain RNA-seq data already aligned using Kallisto for 1,072,742 and 961,625 samples, respectively.  Note that these files will each take about ~40-50GB of space on your hard-drive. For the purposes of this lecture, **you only need to download the mouse data**.
