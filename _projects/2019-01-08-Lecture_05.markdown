...
description: Now that we've aligned our reads, it's time to get our data into R.  We'll take this opportunity to discuss the basics of working in R, including accessing packages, the basic structure of a script, and finding help documentation. With our data in R, we'll talk about study design and use Sleuth for differentially transcript analysis.  
