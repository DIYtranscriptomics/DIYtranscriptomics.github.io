...
subtitle: 'Lecture 1 • watch by Jan 15, 2025'
...
[R Programming Language](http://lib.stat.cmu.edu/R/CRAN/) - The main programming language we'll work with in class.
...
[Windows Subsystem for Linux (WSL)](https://learn.microsoft.com/en-us/windows/wsl/install) - After years of teaching this course and trying to find the best/easiest way for Windows users to navigate the course materials, we have found that it is critical that you install WSL in order to give your system more linux-like capabilities.  ***Please DO NOT skip this step***.
