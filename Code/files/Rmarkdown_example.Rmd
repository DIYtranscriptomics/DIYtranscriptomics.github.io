...
log2.cpm.df <- as_tibble(log2.cpm, rownames = "geneSymbol")
...
log2.cpm.filtered.norm.df <- as_tibble(log2.cpm.filtered.norm, rownames = "geneSymbol")
...
mydata.df <- as_tibble(diffGenes, rownames = "geneSymbol")
